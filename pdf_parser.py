...
Tuned against sample PDF: order P7306548 / MSC 9440000984 (Prestige Hyderabad),
29 pages, 35 line items (0001–0035).
"""
...
# Order number: "P" followed by exactly 7 digits (e.g. P7306548).
...
#     "MSC No. /Job Order: 9440000984 / P7306548"
...
HEADER_VALUE_ORDER: tuple[str, ...] = (
    "order_number",     # values[0]  e.g. P7306548
    "date",             # values[1]  e.g. 7/23/2026
    "zone",             # values[2]  e.g. HYDERABAD
    "quote_number",     # values[3]  e.g. P7306
    "reference_number", # values[4]  e.g. 9440000984  (== MSC No.)
    "print_date",       # values[5]  e.g. 7/22/2026
)
